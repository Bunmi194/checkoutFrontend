...
const Transfer = ({ setActivityCounter, setOnRightToggle }) => {
    ...
    const verifyAccount = async () => {
      ...
      setIsVerified(false);
      setName(`${result.recipientDetails.firstName} ${result.recipientDetails.lastName}`);
      return;
    }
  ...
  return (
    <div className='checkout__transfer__container'>
        <p className='checkout__transfer__text' onClick={transferToUser}>Transfer</p>
        <div className='checkout__transfer__wrapper'>
            <input type="text" placeholder="Enter account number..." className='checkout__transfer' onChange={(e)=>setAccountNumber(e.target.value)} value={accountNumber}/>
            <div className='checkout__transfer__div'>
                <input type="text" placeholder="Enter amount" className='checkout__transfer__amount' onChange={(e)=>setAmount(e.target.value)} value={amount} />
                ...
                <button type='button' className='checkout__transfer__button checkout__btn__click' onClick={transfer}>{name? "Transfer" : "Verify"}</button>
        </div>
        <Modal
        isOpen={isModalOpen}
