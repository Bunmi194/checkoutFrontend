        ...
        <div className='checkout__rightsidebar__container'>
            ...
            <div>
                <p>
                    ...
                    <span className='checkout__card__span'>{accountNumber? `**${accountNumber}`.slice(0, 4) : "****"}</span> 
                    <span className='checkout__card__span'>{accountNumber?`${accountNumber}`.slice(2, 6) : "****"}</span> 
                    <span className='checkout__card__span'>{accountNumber? `${accountNumber}`.slice(6, 10) : "****"}</span> 
                </p>
            </div>
            <div className='checkout__rightsidebar__bottom'>
                <div>
                    <p className='checkout__card__details'>{`${userDetails? userDetails.user.firstName : ""} ${userDetails? userDetails.user.lastName : "Anonymous Acc"}`}</p>
                </div>
                <div>
